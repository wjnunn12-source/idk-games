...
const gameDirectories = ["games/geometry-dash", "games/minecraft","games/poker","games/skate","game/tiny fishing"];
const gameNames = ["Gemometry Dash", "Minecraft","poker","skate","timy fishing"];
