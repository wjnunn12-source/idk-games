...
const gameDirectories = ["games/retro-bowl", "games/black jack","games/poker","games/rolet","games/drivemad","games/bitplanes",];
const gameNames = ["retro bowl", "black jack","poker","rolet","drive mad","bit plains"];
